...
class GestureRecognition:
    ...
    def load_model(self):
        ...
        # Read labels ###########################################################
        new_path_keypoint='Wireless_gesture_controlled_drone\model\keypoint_classifier\keypoint_classifier_label.csv'
        #original_path='model/keypoint_classifier/keypoint_classifier_label.csv'
        with open(new_path_keypoint,
                  encoding='utf-8-sig') as f:
            keypoint_classifier_labels = csv.reader(f)
            keypoint_classifier_labels = [
                row[0] for row in keypoint_classifier_labels
            ]
        new_path_history='Wireless_gesture_controlled_drone\model\point_history_classifier\point_history_classifier_label.csv'
        #original_path='model/point_history_classifier/point_history_classifier_label.csv'
        with open(
                new_path_history,
                encoding='utf-8-sig') as f:
    ...
    def recognize(self, image, number=-1, mode=0):
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                #print(self.point_history,pre_processed_point_history_list,len(pre_processed_point_history_list))                    
                ...
                #print(self.point_history_classifier_labels[most_common_fg_id[0][0]])
